  ...
  <tr>
    ...
    <td width="618" align="center" valign="top" bgcolor="#FFFFFF"> <br>
	  ...
	  Pre 
		...
		<a href="goodsAction.do?action=9&i=<%=number-1%>&typeId=<%=request.getParameter("typeId")%>">
		  Pre</a></td>
          <%}%>
		...
		<a href="goodsAction.do?action=9&i=<%=number+1%>&typeId=<%=request.getParameter("typeId")%>">Next</a>
<%}%>
