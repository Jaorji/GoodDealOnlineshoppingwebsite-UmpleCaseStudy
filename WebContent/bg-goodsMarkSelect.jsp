  ...
  <tr>
    ...
    <td width="618" align="center" valign="top" bgcolor="#FFFFFF"> <br>
        ...
        <table width="610" height="25" border="0" cellpadding="0" cellspacing="0" background="image/bg_02.jpg">
          <tr>
            <td><div align="center"><strong>Sale Item</strong></div></td>
          </tr>
        </table>
        <br>
	  ...
	  Pre 
		...
		<a href="goodsAction.do?action=7&i=<%=number-1%>&status=<%=request.getParameter("status")%>">
		  Pre</a></td>
          <%}%>
		...
		<a href="goodsAction.do?action=7&i=<%=number+1%>&status=<%=request.getParameter("stauts")%>">Next</a>
<%}%>
        </tr>
      </table>
