...
-->
 ...
 if(document.form.account.value==""){
  window.alert("Manager Username")
   document.form.account.focus();
   return false;
 }
 if(document.form.password.value==""){
 window.alert("Manager paaword")
...
<table width="547" height="294" border="0" align="center" cellpadding="0" cellspacing="0" background="image/bg-land.jpg">
  <tr>
    ...
    <td width="422" valign="bottom"><table width="411" border="0">
      <tr>
        <td width="55" height="38"><font color="#9A6634"><strong>Username：</strong></font>          </td>
        <td width="104"><input name="accountName" type="account" class="bgtext" size="15"></td>
        <td width="45">&nbsp;<font color="#9A6634"><strong>Password：</strong></font>          </td>
      ...
      <tr>
        <td height="30" colspan="5"><div align="right"><a href="index.jsp" class="a1">back</a>&nbsp;&nbsp;</div></td>
      </tr>
    </table></td>
  </tr>
</table>
